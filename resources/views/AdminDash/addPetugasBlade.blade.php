    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('simpanpetugas') }}" method="POST" class="row g-3">
                            @csrf
                            <div class="col-md-12">
                            ...
                            <div class="col-12">
                                <label for="Penulis" class="form-label">Password</label>
                            ...
                            <div class="col-md-6">
                                <label for="tahunTerbit" class="form-label">Nama Lengkap</label>
                            ...
                            <div class="col-12">
                                ...
                                <a href="{{ url('TambahPetugas') }}"><button type="button"
